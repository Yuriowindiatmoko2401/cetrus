...
1. Clone Repo and Install Dependencies
   ...
   **Option 2: Alternative versions for different CUDA setups**
   ```bash
   # For CUDA 10.2
   pip install mmcv-full==1.3.17 -f https://download.openmm.org/mmcv/dist/cu102/torch1.7.0/index.html

   # For CUDA 11.0
   pip install mmcv-full==1.3.17 -f https://download.openmm.org/mmcv/dist/cu110/torch1.7.0/index.html

   # For CPU-only
   pip install mmcv-full==1.3.17 -f https://download.openmm.org/mmcv/dist/cpu/torch1.7.0/index.html
   ```

   **Option 3: Using legacy DATSR version (original approach)**
   ```bash
   pip install mmcv-full==0.4.4 -f https://download.openmm.org/mmcv/dist/cu101/torch1.7.0/index.html
   ```
